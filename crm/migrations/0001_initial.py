    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_credit_spec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Кредитный специалист')),
            ],
            options={
                'verbose_name': 'ЧП/ИП',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statistics', models.TextField(verbose_name='Предыдущие переговоры')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own_contribution', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Размер собвственного взноса')),
                ...
                ('id_num_parley', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Entity', to='crm.conversation', verbose_name='Переговоры')),
