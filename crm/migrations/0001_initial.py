    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('success', 'Выдан'), ('processing', 'Обработка'), ('discussion', 'На рассмотрении'), ('denied', 'Отказано'), ('1', 'Погашен за счет отступных'), ('2', 'Судебный')], max_length=30, verbose_name='Статус клиента')),
                ...
                ('monitoring_report', models.FileField(blank=True, null=True, upload_to='media', verbose_name='Oabтчет по мониторингу')),
