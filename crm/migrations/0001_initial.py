# Generated by Django 4.1.4 on 2022-12-20 21:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.client', verbose_name='ЧП/ИП')),
                ...
                ('id_spec', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Кредитный спец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversation', to='crm.client', verbose_name='ЧП/ИП')),
                ('entity_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversation', to='crm.entity', verbose_name='Юр.лицо')),
            ],
            options={
